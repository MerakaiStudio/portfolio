...
import MyPortfolio from '@images/my_portfolio_v1.png'
import TEP from '@logos/TEP_Logo.svg'
    ...
    <section ref={ref} id='project-link' className='projects-container'>
      ...
      { onProject ?
        <div className='projects-grid'>
          <ProjectCard 
            image={MyPortfolio} 
            description={'My Personal Portfolio Website is a professional and visually stunning online portfolio built using the React framework. It serves as a showcase for individuals, freelancers, or creative professionals to display their work, skills, and achievements in a captivating and interactive manner.'} 
        ...
        <div className='projects-grid'>
          <ProjectCard 
            image={Saeta} 
            description={'Promotional video for the opening of the brand in Costa Rican commerce. Emphasizing the different sports in which the brand performs.'} 
          ...
          <ProjectCard 
            image={DN} 
            description={'Overall, the logo design for DN is a captivating visual representation that embodies the brands identity, evokes emotions, and leaves a lasting impression. It serves as a memorable symbol that reinforces the brands presence and fosters recognition among its audience.'} 
            title={'DN Brand'} 
            tags= {['Illustrator']}
          />
          <ProjectCard 
            image={TEP} 
            description={'Creating a brand involves a meticulous process of developing a unique identity and establishing a strong presence in the market. TEP understands the significance of brand creation and has implemented a comprehensive marketing strategy to effectively promote its offerings and engage with its target audience.'} 
            title={'TEP (Re-Branding)'} 
            tags= {['Illustrator', 'Photoshop', 'Canva']}
          />
          <ProjectCard 
            image={JOMA} 
            description={'The process of rebranding a sports team is an exciting and transformative journey that involves refreshing the teams identity, connecting with fans on a deeper level, and positioning the team for long-term success.'} 
